...
const ImageContent = ({ image, title, className }: ImageSectionProps & { className?: string }) => {
  return (
    <section className={`relative w-full h-full min-h-[500px] overflow-hidden lg:rounded-2xl ${className}`}>
      {/* Bakgrundsbild */}
      <div
